...
import com.han.train.generator.util.DbUtil;
import com.han.train.generator.util.Field;
import com.han.train.generator.util.FreemarkerUtil;
...
//        gen(Domain, param, "response", "queryResp");
    ...
    /**
     * 获取所有的Java类型，使用Set去重，防止多次导入相同的包
     */
